...
public class telaGenio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 150, 351, 492));

        lblFrase.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        lblFrase.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblFrase.setText("Frase");
        getContentPane().add(lblFrase, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 60, 180, 140));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/balao genio.png"))); // NOI18N
        ...
        getContentPane().add(txtVal, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 370, 80, 20));

        btnPalpite.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        btnPalpite.setForeground(new java.awt.Color(0, 0, 255));
        ...
        getContentPane().add(btnPalpite, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 470, 180, 80));
